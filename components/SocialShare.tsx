    ...
    <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 items-center">
      ...
      <div className="flex space-x-3">
        ...
        <a 
          ...
          className="w-10 h-10 flex items-center justify-center rounded-full bg-[#1DA1F2] text-white hover:bg-opacity-90 transition-colors"
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="w-10 h-10 flex items-center justify-center rounded-full bg-[#1877F2] text-white hover:bg-opacity-90 transition-colors"
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="w-10 h-10 flex items-center justify-center rounded-full bg-[#0A66C2] text-white hover:bg-opacity-90 transition-colors"
