                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <div className="mt-4 flex flex-wrap gap-4 justify-center md:justify-start items-center">
                    ...
                    {writer.social?.twitter && (
                      <a href={writer.social.twitter} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-[#c8ab3d] transition-colors">
                    ...
                    {writer.social?.linkedin && (
                      <a href={writer.social.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-[#c8ab3d] transition-colors">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    {writer.social?.website && (
                      <a href={writer.social.website} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-[#c8ab3d] transition-colors">
