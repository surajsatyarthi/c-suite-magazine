            ...
            dangerouslySetInnerHTML={safeJsonLd([
              ...
              }),
              {
                ...
                "mainEntity": [
                  {
                    "@type": "Question",
                    "name": "Who is Mahesh Kumar?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Mahesh Kumar is the Founder & CEO of Tiger Analytics. He holds a PhD from MIT Sloan and represented India at the International Mathematical Olympiad."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "What is Tiger Analytics’ current revenue?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Tiger Analytics has reached approximately $750 million in annual revenue and is targeting $500 million in 2026 on its path to $1 billion by 2030."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "What industries does Tiger Analytics serve?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "The company has deep expertise in CPG/Retail, Banking/Financial Services, Life Sciences/Healthcare, Manufacturing/Logistics, and Technology."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "What is Tiger Forge?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Tiger Forge is Tiger Analytics’ AI Agent Development and Management Platform — a no/low-code solution for building, deploying, and governing autonomous AI agents with full observability."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "Is Tiger Analytics planning an IPO?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Yes — the company has publicly stated plans for a public listing as part of its $1 billion revenue goal by 2030."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "How is Tiger Analytics different from other AI consultancies?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "It competes on certainty and explainability rather than model novelty, remains bootstrapped, and delivers measurable ROI through industry-specific platforms."
                    }
                  }
                ]
              }
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_320px] gap-8">
                  <div>
                    ...
                    <div className="prose prose-base md:prose-lg max-w-none">
                      <p>From a modest Santa Clara office in 2011 to a $750 million global AI leader serving 70% of the Fortune 1,000, Mahesh Kumar’s Tiger Analytics has redefined enterprise AI. The company is now targeting $500 million revenue in 2026 and $1 billion by 2030, with a public listing on the horizon.</p>
                      
                      <h3>How did Mahesh Kumar build Tiger Analytics?</h3>
                      <p>Mahesh Kumar built Tiger Analytics by combining world-class academic rigor with a laser focus on business outcomes. After earning a computer science degree from IIT Bombay (1999) and a PhD in Operations Research and Marketing from MIT Sloan, he left academia in 2011 to co-found the company with Pradeep Gulipalli. They bootstrapped the firm with zero external funding and grew it into a 5,000+ person global operation through measurable client results rather than hype.</p>

                      <h3>What makes Tiger Analytics different from other AI firms?</h3>
                      ...
                      <h3>Key Business Impacts and Financial Measurables</h3>
                      <table className="w-full text-left border-collapse border border-gray-300 my-6">
                        <thead>
                          <tr className="bg-gray-100">
                            <th className="border border-gray-300 p-2">Industry</th>
                            <th className="border border-gray-300 p-2">Impact Achieved</th>
                            <th className="border border-gray-300 p-2">Value Delivered</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td className="border border-gray-300 p-2">Food Retail</td>
                            <td className="border border-gray-300 p-2">Inventory & labour optimisation for 11,000-store US leader</td>
                            <td className="border border-gray-300 p-2">$70 million annual cost savings</td>
                          </tr>
                          <tr>
                            <td className="border border-gray-300 p-2">Apparel</td>
                            <td className="border border-gray-300 p-2">Decision intelligence deployment</td>
                            <td className="border border-gray-300 p-2">$20 million revenue uplift in one month</td>
                          </tr>
                          <tr>
                            <td className="border border-gray-300 p-2">Supply Chain (CPG)</td>
                            <td className="border border-gray-300 p-2">End-to-end visibility platform</td>
                            <td className="border border-gray-300 p-2">$200+ million combined revenue & cost opportunities</td>
                          </tr>
                          <tr>
                            <td className="border border-gray-300 p-2">Banking (UK Top-4)</td>
                            <td className="border border-gray-300 p-2">Conversational AI platform</td>
                            <td className="border border-gray-300 p-2">Delivered in 9 months (vs. internal 2-year estimate)</td>
                          </tr>
                        </tbody>
                      </table>

                      <h3>How does Tiger Analytics define Agentic AI and its focus?</h3>
                      <p>Tiger Analytics defines agentic AI as autonomous, governed agents that can plan, execute, and monitor complex tasks with full auditability. Its flagship Tiger Forge platform provides a visual no/low-code Agent Builder, reusable prompt gallery, and Agent Observe dashboard for real-time tracing, cost tracking, and compliance — directly addressing board-level concerns around GenAI governance.</p>

                      <blockquote className="border-l-4 border-[#c8ab3d] pl-4 italic text-gray-700 my-6">
                        “Business leaders need to navigate through a lot of complexity, ambiguity, and constraints — a fog of uncertainty. We cut through this fog, using AI and analytics, enabling businesses to have a clear understanding of the implications of the possible paths forward.”
                      </blockquote>

                      <div className="bg-[#fcf8f1] p-6 rounded-lg my-6">
                        <h4 className="font-bold mb-3 text-[#082945]">Key Takeaways</h4>
                        <ul className="list-disc pl-5 m-0 space-y-2">
                          <li>Tiger Analytics is 100% bootstrapped and focuses on outcomes over hype.</li>
                          <li>Its proprietary platforms accelerate delivery while keeping full customisation and governance.</li>
                          <li>The company is on track for $1 billion revenue by 2030 and an IPO.</li>
                        </ul>
                      </div>

                      <h2>Frequently Asked Questions about Mahesh Kumar and Tiger Analytics</h2>
                      
                      <details className="mb-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                        <summary className="font-bold cursor-pointer p-4 bg-gray-50 rounded-t-lg focus:outline-none">Who is Mahesh Kumar?</summary>
                        <div className="p-4 pt-0 text-gray-700 mt-2">Mahesh Kumar is the Founder & CEO of Tiger Analytics. He holds a PhD from MIT Sloan and represented India at the International Mathematical Olympiad.</div>
                      </details>

                      <details className="mb-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                        <summary className="font-bold cursor-pointer p-4 bg-gray-50 rounded-t-lg focus:outline-none">What is Tiger Analytics’ current revenue?</summary>
                        <div className="p-4 pt-0 text-gray-700 mt-2">Tiger Analytics has reached approximately $750 million in annual revenue and is targeting $500 million in 2026 on its path to $1 billion by 2030.</div>
                      </details>

                      <details className="mb-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                        <summary className="font-bold cursor-pointer p-4 bg-gray-50 rounded-t-lg focus:outline-none">What industries does Tiger Analytics serve?</summary>
                        <div className="p-4 pt-0 text-gray-700 mt-2">The company has deep expertise in CPG/Retail, Banking/Financial Services, Life Sciences/Healthcare, Manufacturing/Logistics, and Technology.</div>
                      </details>

                      <details className="mb-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                        <summary className="font-bold cursor-pointer p-4 bg-gray-50 rounded-t-lg focus:outline-none">What is Tiger Forge?</summary>
                        <div className="p-4 pt-0 text-gray-700 mt-2">Tiger Forge is Tiger Analytics’ AI Agent Development and Management Platform — a no/low-code solution for building, deploying, and governing autonomous AI agents with full observability.</div>
                      </details>

                      <details className="mb-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                        <summary className="font-bold cursor-pointer p-4 bg-gray-50 rounded-t-lg focus:outline-none">Is Tiger Analytics planning an IPO?</summary>
                        <div className="p-4 pt-0 text-gray-700 mt-2">Yes — the company has publicly stated plans for a public listing as part of its $1 billion revenue goal by 2030.</div>
                      </details>

                      <details className="mb-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                        <summary className="font-bold cursor-pointer p-4 bg-gray-50 rounded-t-lg focus:outline-none">How is Tiger Analytics different from other AI consultancies?</summary>
                        <div className="p-4 pt-0 text-gray-700 mt-2">It competes on certainty and explainability rather than model novelty, remains bootstrapped, and delivers measurable ROI through industry-specific platforms.</div>
                      </details>
...
export async function generateMetadata(props: {
  ...
  const params = await props.params;
  const { slug } = params || { slug: "" };
  const post = await getPost("mahesh-kumar-tiger-analytics");
  ...
  return generateSEOMetadata({
    ...
    title: "The Certainty Code: How Mahesh Kumar Built Tiger Analytics Into a $750M AI Powerhouse [AEO Updated \u2013 Safety Copy]",
