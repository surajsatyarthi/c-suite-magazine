...
| **#10** | **Missing Metadata: Views**        | P1       | 🔴 RE-OPENED | 3h   | Implemented Hybrid Model (Jitter + Real).                          |
...
| **#43** | **Ghost Links / URL Resolution**   | P0       | ✅ RESOLVED  | --   | Centralized URL logic; 0 broken links confirmed via Double Spider. |

## Active Roadmap (Next Steps)

1. **#25 Governance: Missing PRD** (Open) - Formalize feature roadmap. [Est: 4h]
2. **#18 Sanity Preview** (Re-Opened) - Fix preview sync issues. [Est: 6h]
3. **#20 Footer/Nav SEO** (Re-Opened) - Improve footer structure. [Est: 4h]
4. **#10 Missing Metadata: Views** (Re-Opened) - Jitter/Real hybrid. [Est: 3h]
